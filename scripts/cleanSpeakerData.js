...
const mapGithub = (speaker) => {
    ...
    if (github) {
        if (github.indexOf('github.com') > -1) {
            return {
                ...speaker,
                github: github.substring(0, github.split('').reverse().join('').indexOf('/')).split('').reverse().join('')
            };
        }
...
const mapTwitter = (speaker) => {
    ...
    if (twitter) {
        if (twitter.indexOf('twitter.com') > -1) {
            return {
                ...speaker,
                twitter: twitter.substring(0, twitter.split('').reverse().join('').indexOf('/')).split('').reverse().join('')
            };
